...
class Sifr
    ...
    #
    # *Usage*: Call at the end of environment.rb with a version (eg '2_0_5') and options as needed:
    #
    #   Sifr.init('2_0_5',:font_path => '/my_fonts/')
    #
    # *Arguments*:
    #
    # [version] One of '2_0_2' or '2_0_5', selects which sifr.js file to use, must match version your fonts were built with
